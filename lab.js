...
if (amysBirthYear === brittanisBirthYear) {
  ...
  console.log(`amy & britanni were not born in the same year.`)
}
...
if (changeMyMind === true) {
  ...
  console.log(`true`, changeMyMind)
} else if (changeMyMind !== true) {
  let changeMyMind = true
  console.log(`false`,changeMyMind)
} 
...
// Use a for-loop to iterate through 'listOfNumbers', then check to see if the number is divisible by 3. If it is, 
...
////////// PROBLEM 14 //////////
// Switch statements can be excellent alternatives to look up a switch statement (I recommend W3 Schools) 
//and try to implement one in the following.
...
//Code Here
 switch(letterGrade) {
   case "A":
     text = "The student id doing excellently.";
     console.log(text)
     break;
   case "B":
